...
class Model():
    def __init__(self, args, infer=False):
        ...
        self.inc_batch_pointer_op = tf.compat.v1.assign(self.batch_pointer, self.batch_pointer + 1)
        self.epoch_pointer = tf.Variable(0, name="epoch_pointer", trainable=False)
        self.batch_time = tf.Variable(0.0, name="batch_time", trainable=False)
        tf.compat.v1.summary.scalar("time_batch", self.batch_time)
        ...
        with tf.compat.v1.variable_scope('rnnlm'):
            ...
            with tf.device("/cpu:0"):
                ...
                inputs = tf.split(tf.nn.embedding_lookup(params=embedding, ids=self.input_data), args.seq_length, 1)
